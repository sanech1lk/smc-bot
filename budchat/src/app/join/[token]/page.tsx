...
export default function JoinPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (!res.ok) {
        setError(data.error ?? "Не удалось присоединиться к объекту");
        return;
      }
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-6 py-10 text-center">
      ...
      {error ? (
        <>
          ...
          <h1 className="mt-3 text-xl font-bold">Приглашение не сработало</h1>
        ...
        <>
          ...
          <h1 className="mt-3 text-xl font-bold">Присоединяем к объекту…</h1>
