    ...
    <div className="hero-wash flex min-h-screen flex-col justify-center px-6 py-10">
      <div className="animate-in mx-auto w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          <Logo size={64} glow />
          <h1 className="mt-5 text-[1.75rem] font-bold tracking-tight">Kelma</h1>
        ...
        <div className="mt-8 rounded-xl border border-border bg-bg-card p-4 text-sm text-text-secondary">
          ...
          <p>prorab@kelma.dev / password123 — {t("auth.login.roleAdmin")}</p>
          <p>master@kelma.dev / password123 — {t("auth.login.roleWorker")}</p>
          <p>client@kelma.dev / password123 — {t("auth.login.roleClient")}</p>
        </div>
